...
LOCAL_EXPORT_CFLAGS := -DSTANDALONE -D__STDC_CONSTANT_MACROS \
...
LOCAL_EXPORT_C_INCLUDES := $(SDKSTAGE)/opt/vc/include
LOCAL_EXPORT_LDLIBS += -L$(SDKSTAGE)/opt/vc/lib -lbrcmGLESv2 -lbrcmEGL \
